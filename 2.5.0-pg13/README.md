...
```console
docker-compose -f ./docker-compose_v3_ubuntu_timescaledb_2.5.0-pg13_latest.yaml up -d
...
docker-compose -f ./docker-compose_v3_ubuntu_timescaledb_2.5.0-pg13_latest.yaml down
```
